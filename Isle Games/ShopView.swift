...
struct ShopView: View {
    ...
    private let cardOptions: [CardOption] = [
        ...
        CardOption(id: "blueCard", buyImage: "blueCardBuy", selectImage: "blueCardSelect", closeImage: "background2", selectedImage: "blueCardSelected"),
        CardOption(id: "pinkCard", buyImage: "pinkCardBuy", selectImage: "pinkCardSelect", closeImage: "background2", selectedImage: "pinkCardSelected")
    ]
